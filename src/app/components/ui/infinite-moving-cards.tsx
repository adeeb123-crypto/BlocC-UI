  ...
  return (
    ...
    >
      <ul
        ref={scrollerRef}
        className={cn(
          " h-[13.5rem] flex min-w-full shrink-0 gap-4 py-4 w-max flex-nowrap",
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[350px] max-w-full relative rounded-2xl border border-b-2 flex-shrink-0 border-black px-8 py-6 md:w-[350px]"
            style={{
              background:
