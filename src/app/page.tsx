...
const testimonials = [
  {
    quote:
      "It was the best of times, , it was the epoch of incredulity,it was the spring of hope, it was the winter of despair.",
    name: "Charles Dickens",
    title: "A Tale of Two Cities",
  },
  {
    quote:
      "To be, or not to be, that is the question: Whether , And by opposing end them: to die, to sleep.",
  ...
  {
    quote:
      "Call me Ishmael. I thought I would sail about a little and see the watery part of the world.",
    ...
    <>
      <nav className="nav-color sticky top-0 z-50 bg-white shadow border-gray-200 dark:bg-gray-900 text-white">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a
            href="https://adeebwaiz.com/"
            className="flex items-center space-x-3 rtl:space-x-reverse"
          >
            <img
              src="https://i.postimg.cc/5jQhrjzq/Electric-Blue-Gradient-Cube-Modern-Company-Business-Technology-Logo.png"
              className=" img-logo h-8"
              alt="Flowbite Logo"
            />
          ...
          <div className="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul className="nav-items font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <a
                  href="#"
                  className="block py-2 px-3 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-400 transition-colors duration-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
                  aria-current="page"
                >
                  Home
                </a>
      ...
      <div className="hero-flex-section w-full min-h-screen">
        <div className="flex-div w-full p-4 text-center border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700 h-auto min-h-[500px]">
          ...
          <form className="max-w-md mx-auto">
            ...
            <div className="relative mx-2 my-8">
              ...
              <input
                type="search"
                id="default-search"
                className="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-900 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="Search Mockups, Logos..."
                required
              />
              <button
                type="submit"
                className=" search-button text-white absolute end-2.5 bottom-2.5 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              >
                Search
              </button>
            </div>
          ...
          <a
            href="#"
            className="custom-card1 custom-card-color block max-w-sm p-14 mx-2 my-8 rounded-md shadow dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"
          >
            <h5 className="mb-2 text-2xl font-semibold tracking-tight custom-text-color dark:text-white">
              2020
            </h5>
            <p className="custom-text-color font-extralight dark:text-gray-400">
              Here are the biggest enterprise technology acquisitions of 2020 so
          ...
          <a
            href="#"
            className="custom-card1 card3 custom-card-color block max-w-sm p-14 mx-2 my-8 rounded-md shadow dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"
          >
            <h5 className="mb-2 text-2xl font-semibold tracking-tight custom-text-color dark:text-white">
              2020
            </h5>
      ...
      <div className="about-test-box">
        <div className="custom-shape-divider-bottom-1721554703">
          <svg
            data-name="Layer 1"
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="about-block-section w-full min-h-screen flex items-center justify-center">
          <div className="about-flex-section text-white">
            <div className="company-text-box">
              <div>
                tex ewq dewqad dwqaqdwq edwqdwq edwqd edwqede redwq rwq dfwq
                r3wq rd q rf3qw r3qwedt
              </div>
            </div>
            <div className="company-img-box">
              <img
                src="https://insomnia.rest/images/home/product-ui.png"
                className="img-company-mockup"
                alt="Flowbite Logo"
              />
            </div>
          </div>
      ...
      <div className="testimonials-box">
        <div className="testimonials-block-section w-full min-h-screen flex items-center justify-center">
          <div className=" moving-cards-box h-[45rem] w-100 rounded-md flex flex-col antialiased bg-white dark:bg-black dark:bg-grid-white/[0.05] items-center justify-center relative overflow-hidden">
            <InfiniteMovingCards
              items={testimonials}
              direction="right"
              speed="slow"
      ...
      <footer className="custom-footer bg-white dark:bg-gray-900">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
              <a href="https://adeebwaiz.com/" className="flex items-center">
                <img
                  src="https://i.postimg.cc/5jQhrjzq/Electric-Blue-Gradient-Cube-Modern-Company-Business-Technology-Logo.png"
                  className="h-8 me-3"
                  alt="FlowBite Logo"
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                <h2 className="mb-6 text-sm font-semibold text-white-100 uppercase dark:text-white">
                  Resources
                </h2>
